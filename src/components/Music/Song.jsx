    ...
    return (
      <div className={styles.container}>
        <div className={styles.cover} style={{ backgroundImage: cover ? `url(${cover})` : '' }}>
          <button className={`${styles.button} ${styles.play}`} type="button">
            <svg viewBox="0 0 24 24">
              {true && <path d="M10,16.5V7.5L16,12M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />}
              {false && <path d="M15,16H13V8H15M11,16H9V8H11M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z" />}
            </svg>
          </button>
          {!cover && (
            <svg viewBox="0 0 24 24">
        ...
        <div className={styles.actions}>
          ...
          >
            <svg className={`${styles.icon}${favorite ? ` ${styles.on}` : ''}`} viewBox="0 0 24 24">
